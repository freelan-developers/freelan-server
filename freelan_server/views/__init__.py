...
from freelan_server.views.settings_wizard import settings_wizard
...
def setup_views(app):
    ...
    app.add_url_rule('/settings_wizard', view_func=settings_wizard, methods=['GET', 'POST'])
    app.add_url_rule('/settings_wizard/<int:step>', view_func=settings_wizard, methods=['GET', 'POST'])
